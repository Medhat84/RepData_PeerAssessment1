...
Daily steps mean after imputing is **`r temp1`** and median is **`r temp2`**. That means that imputing the missing data caused the values of mean & median to be almost equal.
